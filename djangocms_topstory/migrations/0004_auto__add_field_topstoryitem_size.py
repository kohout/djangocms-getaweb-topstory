...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopStoryItem.size'
        db.add_column(u'djangocms_topstory_topstoryitem', 'size',
                      self.gf('django.db.models.fields.CharField')(default=('masonry', u'300x800, ohne crop'), max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopStoryItem.size'
        db.delete_column(u'djangocms_topstory_topstoryitem', 'size')
