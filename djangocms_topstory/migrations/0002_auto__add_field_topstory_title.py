...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopStory.title'
        db.add_column(u'djangocms_topstory_topstory', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopStory.title'
        db.delete_column(u'djangocms_topstory_topstory', 'title')
