...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopStoryItem.teaser_layout'
        db.add_column(u'djangocms_topstory_topstoryitem', 'teaser_layout',
                      self.gf('django.db.models.fields.CharField')(default=('white', u'Wei\xdfer Hintergrund, Schwarze Schrift'), max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopStoryItem.teaser_layout'
        db.delete_column(u'djangocms_topstory_topstoryitem', 'teaser_layout')
    ...
    models = {
        ...
        u'djangocms_topstory.topstoryitem': {
            ...
            'size': ('django.db.models.fields.CharField', [], {'default': "('masonry', u'300x800, ohne crop')", 'max_length': '50'}),
            'teaser_layout': ('django.db.models.fields.CharField', [], {'default': "('white', u'Wei\\xdfer Hintergrund, Schwarze Schrift')", 'max_length': '100'}),
            'teaser_position': ('django.db.models.fields.CharField', [], {'default': "('left', u'left')", 'max_length': '50'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
