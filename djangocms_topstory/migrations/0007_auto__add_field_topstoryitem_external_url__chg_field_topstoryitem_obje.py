...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TopStoryItem.external_url'
        db.add_column(u'djangocms_topstory_topstoryitem', 'external_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TopStoryItem.external_url'
        db.delete_column(u'djangocms_topstory_topstoryitem', 'external_url')
